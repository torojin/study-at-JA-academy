...
public class BoardDao {
	...
	public BoardVo ViewByNo(int no) {
		...
		try {
			...
			if(rs.next()) {
				...
				boardVo = new BoardVo(b_no,m_no,b_title,b_content,b_count,b_writedate);
			}
		}catch(Exception e) {
			e.printStackTrace();
		}finally {
